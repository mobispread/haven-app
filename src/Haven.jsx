    ...
    <div style={{ maxWidth:430, margin:"0 auto", minHeight:"100vh", background:colors.cream, fontFamily:"'Helvetica Neue', Arial, sans-serif", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{
        ...
        <div style={{ display:"flex", gap:8, alignItems:"center" }}>
          <button title="Chat Assistant" style={{ background:C.yellow, border:"none", color:C.emeraldDeep, width:34, height:34, borderRadius:9, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", boxShadow:"0 2px 8px rgba(0,0,0,0.15)" }}>
          ...
          <button title="Notifications" onClick={() => setShowNotif(o => !o)} style={{ background: showNotif ? "rgba(255,255,255,0.35)" : "rgba(255,255,255,0.15)", border: showNotif ? "1.5px solid rgba(255,255,255,0.6)" : "1.5px solid transparent", color:"#fff", width:34, height:34, borderRadius:9, fontSize:17, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", transition:"all 0.15s" }}>🔔</button>
          <button title={dark ? "Switch to Light Mode" : "Switch to Dark Mode"} onClick={() => setDark(d => !d)} style={{ background:"rgba(255,255,255,0.15)", border:"none", color:"#fff", width:34, height:34, borderRadius:9, fontSize:16, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" }}>
            {dark ? "☀️" : "🌙"}
          </button>
        </div>
      </div>
